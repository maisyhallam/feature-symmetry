...
generation1_pairs = [('mB','mZ'),('meB','meZ'),('myB','myZ'),('mMeZeS','mMeZeD'),('mMeZyS','mMeZyD'),('mMeZS','mMeZD'),
...
generation2_pairs = [('mMB','mMZ'),('mFB','mFZ'),('mMeB','mMeZ'),('mMyB','mMyZ'),('mFeB','mFeZ'),('mFyB','mFyZ')]
