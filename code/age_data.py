...
pairs = [('meB','myB'),('meZ','myZ'), ('mMeZeS','mMeZyS'),('mMeZeD','mMeZyD'),('mMyZeS','mMyZyS'),('mMyZeD','mMyZyD'),('mMZeS','mMZyS'),
('mMZeD','mMZyD'),('mMeBeS','mMeByS'),('mMeBeD','mMeByD'),('mMyBeS','mMyByS'),('mMyBeD','mMyByD'),('mMBeS','mMByS'),('mMBeD','mMByD'),
('mFeZeS','mFeZyS'),('mFeZeD','mFeZyD'),('mFyZeS','mFyZyS'),('mFyZeD','mFyZyD'),('mFZeS','mFZyS'),('mFZeD','mFZyD'),('mFeBeS','mFeByS'),
('mFeBeD','mFeByD'),('mFyBeS','mFyByS'),('mFyBeD','mFyByD'),('mFBeS','mFByS'),('mFBeD','mFByD'),('mMeB','mMyB'),('mMeZ','mMyZ'),('mFeB','mFyB'),('mFeZ','mFyZ')]
