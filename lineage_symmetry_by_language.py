...
with open('lineage_distinction_pruned.csv', 'a') as csv_file:
    csvwriter = csv.writer(csv_file)
...
for family in families:
    ...
    for file in files:
        ...
        language = get_language_name(file)
        # symmetries = []
        feature_symmetry_results = check_feature_symmetry(kin_terms,'lineage')
        gen_results = generation_results(feature_symmetry_results)

        write_full_csv('lineage_distinction_pruned.csv',file,gen_results)
